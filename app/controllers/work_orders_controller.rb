class WorkOrdersController < ApplicationController
  ...
  def create
    ...
    #This will call the private method in the work order to get it to assign 
    #itself a technician. Kind of hack-ey but it works
    @work_order.send(:assign_technician)
    respond_to do |format|
      if @work_order.save
